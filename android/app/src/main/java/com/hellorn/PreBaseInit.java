...
//                    .setJavaScriptExecutorFactory(new HermesExecutorFactory())
                    ...
                    .setJSBundleFile(getFilesDir()+"/index/index.android.bundle")
                    .addPackages(List.of(new DeviceInfoPackage()))
        ...
        mReactInstanceManager = MainApplication.instance.getRcInstanceManager();
...
//        String basePhat = RNToolsManager.currentVersionByBundleName(getApplicationContext()).get("moduleType");
        ...
        // 加载对应的 load
        if(true){
            filePath$Name = getApplication().getFilesDir() +"/index/index.android.bundle"; //getApplicationContext().getExternalFilesDir(null).getAbsolutePath() + "/Bundle/"+ basePhat + "/" + getJSBundleAssetName();
        }else{
